...
import static com.lloyds.data.automation.service.QualityCheckService.listDuplicateId;
...
public class QualityCheckSteps {
    ...
    public void addToLog(String s, int row) {
    ...
    public void addToFailedLog(String s, int row) {
        LogFile logFile = LogFile.builder( ).creationDate(LocalDateTime.now( )).
